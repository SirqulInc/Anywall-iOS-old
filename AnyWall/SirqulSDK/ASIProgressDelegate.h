...
- (void)request:(SirqulASIHTTPRequest *)request didReceiveBytes:(long long)bytes;
...
- (void)request:(SirqulASIHTTPRequest *)request didSendBytes:(long long)bytes;

// Called when a request needs to change the length of the content to download
- (void)request:(SirqulASIHTTPRequest *)request incrementDownloadSizeBy:(long long)newLength;

// Called when a request needs to change the length of the content to upload
// newLength may be less than zero when a request needs to remove the size of the internal buffer from progress tracking
- (void)request:(SirqulASIHTTPRequest *)request incrementUploadSizeBy:(long long)newLength;
@end
