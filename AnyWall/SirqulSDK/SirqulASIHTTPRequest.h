...
@class SirqulASIDataDecompressor;

extern NSString *SirqulASIHTTPRequestVersion;
...
extern NSString* const SirqulNetworkRequestErrorDomain;
...
extern unsigned long const SirqulASIWWANBandwidthThrottleAmount;
...
@interface SirqulASIHTTPRequest : NSOperation <NSCopying> {
	...
	SirqulASIHTTPRequest *mainRequest;
	...
	SirqulASIDataDecompressor *dataDecompressor;
	...
	SirqulASIHTTPRequest *PACFileRequest;
...
- (SirqulASIHTTPRequest *)HEADRequest;
...
+ (NSThread *)threadForRequest:(SirqulASIHTTPRequest *)request;
...
@property (assign) SirqulASIHTTPRequest *mainRequest;
...
#endif
@property (retain) SirqulASIDataDecompressor *dataDecompressor;
