...
- (void)tableView:(UITableView *)aTableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	if (indexPath.section == kPAWSettingsTableViewDistance) {
		...
		[aTableView deselectRowAtIndexPath:indexPath animated:YES];
		UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Log out of DoneDid?" message:nil delegate:self cancelButtonTitle:@"Log out" otherButtonTitles:@"Cancel", nil];
		[alertView show];
	}
}
...
//		[PFUser logOut];
		...
		[interface setStatus:kSirqulStatusLogout];
		[interface logoutWithAccountId:[[NSUserDefaults standardUserDefaults]objectForKey:@"accountId"] andLocation:nil];
